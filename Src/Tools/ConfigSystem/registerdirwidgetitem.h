...
#define ROBOTSDKSH "/etc/profile.d/RobotSDK.sh"
#define ROBOTSDKPATHSH "/etc/profile.d/RobotSDK_PATH.sh"
#define ROBOTSDKLIBSH "/etc/ld.so.conf.d/RobotSDK_LIB.conf"
